 ...
 * @author heber
 */
public class AdminReadEditVendor extends javax.swing.JFrame {

    /**
     * Creates new form AdminCustomerRegistration
     */
    public AdminReadEditVendor() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminReadEditVendor.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminReadEditVendor().setVisible(true);
            }
        });
    }
