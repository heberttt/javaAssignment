 ...
 * @author heber
 */
public class AdminReadEditRunner extends javax.swing.JFrame {

    /**
     * Creates new form AdminCustomerRegistration
     */
    public AdminReadEditRunner() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AdminReadEditRunner.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AdminReadEditRunner().setVisible(true);
            }
        });
    }
